...
"""
FastAPI application for the Guardrail Env Environment.

This module creates an HTTP server that exposes the GuardrailEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m guardrail_env.server.app
    ...
    multiple workers:
        uvicorn guardrail_env.server.app:app --workers 4
    """
    import uvicorn
